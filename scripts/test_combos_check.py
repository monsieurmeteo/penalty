...
assert summary.get("won") == 7, f"Expected 7 won, got {summary.get('won')}"
assert summary.get("lost") == 7, f"Expected 7 lost, got {summary.get('lost')}"
assert summary.get("upcoming") == 6, f"Expected 6 upcoming, got {summary.get('upcoming')}"
...
# Verify Ticket #13 (Email #1): Palestino + Corinthians (@2.35) -> LOST (Corinthians 1-2)
t13 = combos[12]
